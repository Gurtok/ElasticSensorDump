...
class SensorRunnable implements Runnable {
  ...
  final static String STOP_SENSOR_THREAD = "esd.serviceManager.message.sensor.STOP_SENSOR_THREAD";
  /**
...
// Guts.
  ...
  public void sensorPower( boolean power ){
    sensorListener.setSensorLogging(power);
  }
  ...
  public void audioPower( boolean power ){

  }

  public void setInterval( int rate ){
  ...
  private void registerMessageReceiver() {
    ...
    filter.addAction(STOP_SENSOR_THREAD);
